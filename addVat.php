...
<?php
   ...
   $store = "SELECT * FROM vat order by name";
   $store2 = "SELECT * FROM vat order by name";
   ...
   <body onload=printdate();>
      ...
      <div class="col-md-10" style = "background: rgb(252, 235, 255);">
         <?php if (isset($_GET['msg'])){
            ...
            ?>
         <h3>Update your existing Vat Stock</h3>
         ...
         <div class="editForm" id="">
            <div class="formWrapper grid ediTformWrapper">
               <h1> Update existing vat  product</h1>
               ...
               <form id="jsform" method="POST" action="functions/obj.php">
                  ...
                  <div class="button d-flex justify-content-end">
                     <button type="submit" name = "addExistingvatStock" onsubmit = >Add data</button>
                  </div>
               </form>
            </div>
