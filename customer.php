            ...
            <table class="table" style="background-color:#fff">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                     <a class="edit" href="functions/cus_edit.php?ID=<?php echo $row['id']; ?>" title="Click here to edit this data"> <i class="fas fa-edit"></i>Edit</a>

                        <form method="POST" action="functions/obj.php" style="display:block; margin:0px; padding:0px"> 
                           <input type = "text" name = "id" value = "<?php echo $row['id']; ?>" style="display:none" >
                           <button style="border:none; background:none" type="submit" name="deleteCustomer" onclick="return confirm('Are you sure you want to remove this admin?');" title="Click here to delete this data"> 
