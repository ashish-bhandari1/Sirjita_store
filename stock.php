<?php
  ...
  if(isset($_POST['filter']) && $_POST["product"] != "all"){
    $id = $_POST["product"];
  ...
  <body onload=printdate();>
    ...
    <div class="UploadFrom" id="formWrap">
      <div class="formWrapper grid">
        <h1> Add New Product  <span class="close" id="closeform" onclick="closeFrom();" >&times;</span></h1>
      ...
      <div class="col-md-10">
         ...
         <div class="buttoms">
              ...
              <select name="product" required="required">
                ...
                <option value = "all">Out Of Stock </option>
