...
<html>
   ...
   <body style = "background: rgb(252, 245, 255);">
      <!-- top nav end -->
      <!-- THEATRE UPDATE FORM  _________________ START -->
      <div class="editForm" id="formWrap">
         <div class="formWrapper grid ">
            <h1> Update vat stock detail<a href="../vat.php" style="text-decoration:none" onclick="return confirm('Are you exit current form?');"class='a' ><span class="close" id="closeform" >&times;</span></a></h1>
            ...
            <form method="POST" action="../functions/obj.php">
               ...
               <div class="inputWrapper">
                  <div class="input">
                     ...
                     <input type="number"  name="quantity" required="required" value = "<?php echo $row['quantity']?>">
                  </div>
               </div>
               <div class="inputWrapper">
                  <div class="input">
               ...
               <div class="button d-flex justify-content-end">
                  <a href="../vat.php"onclick="return confirm('Are you exit current form?');" >Back</a>
                  <button type="submit" name="vatEdit" >Update</button>
               </div>
            </form>
         </div>
      </div>
