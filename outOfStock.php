<?php
  ...
  $sql = "SELECT * FROM stock WHERE quantity <=2 order by name";
  if(isset($_POST['filter']) && $_POST["product"] == "oos"){
    $sql = "SELECT * FROM stock WHERE quantity = 0 and sub_stock = 0 order by name";
  }
...
<html>
  ...
  <body onload=printdate();>
    ...
    <?php
         ...
         ?>
      <div class="col-md-10">
         <h3>Stock Going to be Finished</h3>
         <?php if (isset($_GET['msg'])){
            echo $_GET['msg'];
            }    
            ?>
         <div class="buttoms">
              <form method = "POST" action = "outOfStock.php">
            ...
            <table class="table table-bordered" style="background-color:rgb(255, 215, 215)" >
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><img alt = "no Image" src="dbimage/<?php echo $row['image'] ?>  "></td>
                     ...
                     <td>
                      <a class="edit" href="functions/stock_edit.php?ID=<?php echo $row['id']; ?>" title="Click here to edit this data"> <i class="fas fa-edit"></i>Edit</a>
                        <form method="POST" action="functions/obj.php" style="display:block; margin:0px; padding:0px"> 
                           <input type = "text" name = "id" value = "<?php echo $row['id']; ?>" style="display:none" >
                           <button style="border:none; background:none" type="submit" name="deleteStock" onclick="return confirm('Are you sure you want to delete this menu?');" title="Click here to delete this data"> 
